...
// import { getAverageMonthlyExpense, getCurrentMonthExpense } from "../lib/data";
...
//       />
//       {/* <CardItem
//         label="Monthly Average Expense"
//         amount={monthlyAverageExpense}
...
// import { Wallet, DollarSign, ArrowDownCircle } from "lucide-react";
// import React from "react";
// import { getAverageMonthlyExpense, getCurrentMonthExpense, getTotalOverdueAmount } from "../lib/data";
...
export default function Cards() {
  ...
  const [monthlyAverageExpense, setMonthlyAverageExpense] = useState(0);
  const [totalOverdueAmount, setTotalOverdueAmount] = useState(0);

  useEffect(() => {
    const fetchData = async () => {
      try {
        const [current, average, overdue] = await Promise.all([
          getCurrentMonthExpense(),
          getAverageMonthlyExpense(),
          getTotalOverdueAmount(),
        ]);
        setCurrentMonthExpense(current);
        setMonthlyAverageExpense(average);
        setTotalOverdueAmount(overdue);
      } catch (err) {
